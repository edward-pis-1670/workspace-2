    ...
    $.post(
      ...
      (data, status) => {
        ...
        if (data.code == 200) {
          ...
          return this.refs.modalCreateCourse.setState({
            isSubmitting: false,
            coursename: "",
            showModal: false,
          });
          ...
          <div className="container">
            ...
            <Row>
              ...
              <div className="col-xs-4">
                ...
                >
                  <span className="glyphicon glyphicon-pencil"></span> Create
                  Course
                </button>
              </div>
            </Row>
            <ul className="mycourses-navbar">
              ...
              <li>
                <Link to="/mycourses/wishlist">Wishlist</Link>
              </li>
              <li>
                <Link
        ...
        <div className="instructor-infor-box">
          <div className="container">
            ...
            <div className="col-sm-4">
              ...
              <h4 className="text-success">
                {this.props.mycourses
                  .map((o) => (o.numberofstudent ? o.numberofstudent : 0))
                  .reduce((a, b) => a + b, 0)}{" "}
