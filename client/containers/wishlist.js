...
class Wishlist extends React.Component {
    ...
    onClickPrev(e) {
        ...
        let url = '/mycourses/wishlist' + '?page=' + (query.page - 1)
    ...
    onClickNext(e) {
        ...
        let url = '/mycourses/wishlist' + '?page=' + (parseInt(query.page) + 1)
            + (query.name ? ('&name=' + query.name) : '') + (query.level ? ('&level=' + query.level) : '') + (query.free ? ('&free=' + query.free) : '')
            + (query.sort ? ('&sort=' + query.sort) : '')
        browserHistory.push(url)
    }
    onChangeFilterLevel(e) {
        ...
        let url = '/mycourses/wishlist' + '?page=' + query.page
                ...
                <div className='container'>
                    ...
                    <ul className="mycourses-navbar">
                        ...
                        <li><Link activeClassName="active"
                            onlyActiveOnIndex={true} to='/mycourses/wishlist'>Wishlist</Link></li>
