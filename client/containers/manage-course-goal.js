...
class ManageCourseGoal extends React.Component {
    ...
    onClickAddTS() {
        this.setState({
            targetstudent: [...this.state.targetstudent, this.state.current_targetstudent]
        })
                ...
                <div className="managecourse-content">
                    <div className="item">
                        ...
                        <div className="input-group input-group-lg">
                            ...
                            <div className="input-group-btn">
                                <button type="button" disabled={this.state.current_needtoknow == ''}
                    ...
                    <div className="item">
                        ...
                        <div className="input-group input-group-lg">
                            ...
                            <div className="input-group-btn">
                                <button type="button" disabled={this.state.current_targetstudent == ''}
                    ...
                    <div className="item">
                        ...
                        <div className="input-group input-group-lg">
                            ...
                            <div className="input-group-btn">
                                <button type="button" disabled={this.state.current_willableto == ''}
