  ...
  render() {
    return (
      ...
      >
        ...
        <Modal.Footer>
          <Button positive onClick={(e) => this.depositFunds(e)}>
            Confirm ${this.state.money}USD
          </Button>
        </Modal.Footer>
      </Modal>
    );
  ...
  render() {
    return (
      ...
      >
        ...
        <Modal.Footer>
          <Button negative onClick={(e) => this.withDraw(e)}>
            Confirm ${this.state.money}USD
          </Button>
        </Modal.Footer>
      </Modal>
      ...
      <div>
        ...
        <div className="edit-user-content">
          <h4 style={{ fontWeight: "bold", display: "inline" }}>
            Your total Academy credits: USD${this.props.balance.toFixed(2)}{" "}
          </h4>
          <Button.Group size="mini">
            <Button positive onClick={(e) => this.showModalDepositFunds(e)}>
              Deposit Funds
            </Button>
            <Button.Or />
            <Button negative onClick={(e) => this.showModalWithDraw(e)}>
              Withdraw Money
            </Button>
          </Button.Group>
          <h4 style={{ fontWeight: "bold" }}>
            Enter PayPal-Id(It is your e-mail address you used to register with
            PayPal)
          </h4>
          <Input
            fluid
            ...
            onChange={(e) => this.handlePayPalId(e)}
                ...
                return (
                  <Table.Row key={index}>
                        ...
                        <div>
                          <div>
                            ...
                            <Link
                              to={
                                payment.type == 2
                                  ? "/course/" + payment.information.course._id
                                  : "/managecourse/" +
                                    payment.information.course._id +
                                    "/goals"
                              }
                            >
                    ...
                    <Table.Cell textAlign="center">
                      <Button
                        positive
                        onClick={(e) => this.deletePayment(e, payment, index)}
                      >
          ...
          <ModalDepositFunds
            ...
            ref={(ref) => (this.modalDepositFunds = ref)}
          />
          <ModalWithDraw
            withDraw={this.withDraw.bind(this)}
            ref={(ref) => (this.modalWithDraw = ref)}
          />
          <Pager>
            <Pager.Item
