...
const setUser = (state = {}, action) => {
  ...
  switch (action.type) {
    ...
    case ActionTypes.CREATE_COURSE:
      ...
      else newState.mycourses = [action.course];
      return newState;
    ...
    case ActionTypes.SET_COURSE_PREVIEW_VIDEO:
      if (!newState.mycourses || newState.mycourses.length == 0) {
        ...
        if (index < 0) {
          newState.mycourses = [
            { _id: action.courseid, previewvideo: action.previewvideo },
            ...newState.mycourses,
          ];
        } else {
    ...
    case ActionTypes.ADD_LECTURE:
      ...
      if (newState.mycourses[index].lectures)
        newState.mycourses[index].lectures = [
          ...newState.mycourses[index].lectures,
          action.lecture,
        ];
      else newState.mycourses[index].lectures = [action.lecture];
      return newState;
    case ActionTypes.DELETE_LECTURE:
      let indexc = _.findIndex(newState.mycourses, { _id: action.courseid });
      let indexl = _.findIndex(newState.mycourses[indexc].lectures, {
    ...
    case ActionTypes.SET_LECTURE_VIDEO:
      ...
      let idl = _.findIndex(newState.mycourses[idc].lectures, {
    ...
    case ActionTypes.SET_LECTURE_NAME:
      ...
      let idln = _.findIndex(newState.mycourses[idcn].lectures, {
        _id: action.lecture._id,
      });
    ...
    case ActionTypes.SET_LECTURE_PREVIEW:
      ...
      let idlp = _.findIndex(newState.mycourses[idcp].lectures, {
        _id: action.lecture._id,
      });
    ...
    case ActionTypes.CHANGE_WISHLIST:
      if (action.typeAction == "add") {
        ...
        let index = _.findIndex(newState.mywishlist, (o) => {
    ...
    case ActionTypes.TAKE_COURSE:
      if (
        ...
        newState.mylearningcourses.length == 0
      ) {
        newState.mylearningcourses = [];
    ...
    case ActionTypes.MARK_READ:
      if (newState.notis) {
        let i = _.findIndex(newState.notis, (o) => {
        ...
        noti.seen = true;
        newState.notis = [
          ...newState.notis.slice(0, i),
          noti,
          ...newState.notis.slice(i + 1),
        ];
      }
      return newState;
