    ...
    return (
      <div>
        <h4 style={{ fontWeight: "bold", display: "inline" }}>
          Total Profit: USD${this.state.totalprofit.toFixed(2)}{" "}
        </h4>

        <h4 style={{ fontWeight: "bold" }}>
          Enter Credit Card Number(It is your visa card number you used to
          linked with PayPal)
        </h4>
        <Input
          fluid
        ...
        >
          ...
          <Button
            ...
            positive
            onClick={(e) => this.setCardNumber(e)}
          >
            Save
          </Button>
        </Input>
        ...
        <Input
          ...
          onChange={(e) => this.handleProfitRatio(e)}
        ...
        >
          ...
          <Button
            ...
            positive
            onClick={(e) => this.setProfitRatio(e)}
          >
            Save
          </Button>
        </Input>
