...
class ModalAddUser extends Component {
  ...
  Process() {
    $.post("/api/admin/add-user", this.state, (data, status) => {
      if (data.code == 200) {
            ...
            <div className="form-group">
              ...
              <div className="input-group">
                ...
                <input
                  ...
                  onChange={(e) => this.handleWebsite(e)}
                />
              </div>
            </div>
            <div className="form-group">
              <div className="input-group">
                ...
                <input
                  ...
                  onChange={(e) => this.handleTwitter(e)}
                />
              </div>
            </div>
            <div className="form-group">
              <div className="input-group">
                ...
                <input
                  ...
                  onChange={(e) => this.handleLinkedin(e)}
                />
              </div>
            </div>
            <div className="form-group">
              <div className="input-group">
                ...
                <input
                  ...
                  onChange={(e) => this.handleYoutube(e)}
                />
              </div>
            </div>
            <div className="form-group">
              ...
              <div className="input-group">
                ...
                <input
                  ...
                  onChange={(e) => this.handleCredit(e)}
                />
              </div>
            </div>
            <div className="form-group">
...
class ModalEditUser extends Component {
  ...
  Process() {
    $.post("/api/admin/edit-user", this.state.user, (data, status) => {
      if (data.code == 200) {
        this.setState({ modalOpen: false });
...
class AdminUser extends Component {
  ...
  deleteUser(_id) {
    $.post("/api/admin/delete-user", { _id: _id }, (data, status) => {
      if (data.code == 200) {
  ...
  render() {
    return (
      <div>
                ...
                <Table.Row key={index}>
                  ...
                  <Table.Cell textAlign="center">
                    <Button.Group size="mini">
                      <Button positive onClick={(e) => this.editUser(e, user)}>
        ...
        <ModalEditUser
          ref={(ref) => (this.modalEditUser = ref)}
          onEditSuccess={(e) => this.onEditSuccess(e)}
        />
        <Pager>
          <Pager.Item
            disabled={
