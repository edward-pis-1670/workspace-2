...
class AdminCourse extends Component {
    ...
    onClickPrev(e) {
        ...
        let url = '/admin/courses' + '?page=' + (query.page - 1)
    ...
    onClickNext(e) {
        ...
        let url = '/admin/courses' + '?page=' + (parseInt(query.page) + 1)
            + (query.searchQuery ? ('&searchQuery=' + query.searchQuery) : '')
            + (query.sort ? ('&sort=' + query.sort) : '')
        browserHistory.push(url)
    }
    onChangeFilterSort(e) {
        ...
        let url = '/admin/courses' + '?page=' + query.page
            + (query.searchQuery ? ('&searchQuery=' + query.searchQuery) : '')
            + '&sort=' + e.target.value
        browserHistory.push(url)
    }
                    ...
                    {this.state.courses.map((course, index) => {
                        return <Table.Row key={index}>
                            ...
                            <Table.Cell textAlign='center'>
                                {course.public ? <Icon color='green' name='checkmark' size='large' /> : ''}
                            </Table.Cell>
                            <Table.Cell>
                            ...
                            <Table.Cell textAlign='center'>
                                <Button.Group size='mini'>
                                    ...
                                    <Button.Or />
                                    <Button negative onClick={e => this.deleteCourse(course._id)}><Glyphicon glyph='trash' /></Button>
                                </Button.Group>
                            </Table.Cell>
                        </Table.Row>
                    })}
